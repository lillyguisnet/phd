...
image = cv2.imread('/home/maxime/prg/phd/dev/data_eggs/a_p1_01_eggs.png')
...
show_anns(masks)
plt.axis('off')
plt.savefig('eggsdef.png', bbox_inches='tight', pad_inches=0)

#Default masks for tstimgs
imgs_path = "/home/maxime/prg/phd/dev/data_eggs/"
...
for img in glob.glob(imgs_path + "*.png"):
    ...
    show_anns(masks)
    plt.axis('off')
    plt.savefig("/home/maxime/prg/phd/dev/eggs/default_masks/def_" + img.split(os.sep)[-1], bbox_inches='tight', pad_inches=0)
