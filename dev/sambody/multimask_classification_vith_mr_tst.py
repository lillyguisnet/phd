...
data_dir = '/home/maxime/prg/phd/dev/sambody/multimask_classification_training'
...
model_conv.heads.head = nn.Linear(num_ftrs, 2)
...
model_classif = torch.load("classifier_perfect_pickle.pt")
model_classif = model_classif.to(device)
model_classif.eval()  # Set the model to evaluation mode
...
visualize_model_predictions(
    ...
    model_classif,
    img_path='/home/maxime/prg/phd/dev/sambody/multimask_cutouts/c1_c_p4_01a_d4.png'
)


visualize_model_predictions(
    model_trained,
    img_path='/home/maxime/prg/phd/dev/sambody/multimask_cutouts/' + noclass[5]
)
